...
export default function Login() {
  ...
  return (
    <div>
      <SecondNavbar />
      <div className="flex flex-col items-center justify-center bg-searchBar-background">
        <h2 className="text-base font-bold font-Raleway xl:text-lg text-seconday-gray mt-36">
          Inciciar Sesion
        </h2>
        <form className="flex flex-col gap-6 mt-6 " onSubmit={handleSubmit}>
          <div className="flex flex-col items-center ">
            <label className="hidden sr-only " htmlFor="email">
              Email:
            </label>
            <input
          ...
          <div className="flex flex-col items-center ">
            <label className="hidden sr-only " htmlFor="password">
              Password:
            </label>
            <input
              className="block p-2.5 w-[17rem] xl:w-[26.4375rem] font-Raleway font-normal text-base text-seconday-gray border border-primary-blue outline-none"
