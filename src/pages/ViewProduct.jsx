...
export default function ViewProduct() {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col justify-center bg-searchBar-background md:p-4">
                <div className=" md:flex md:flex-row md:gap-4 lg:justify-center lg:items-center xl:max-w-[80rem] xl:mx-auto xl:mt-16">
                    <img
                ...
                <div className=" p-4 xl:p-0 xl:mb-16 xl:max-w-[80rem]">
