...
export default function Contact() {
  ...
  return (
    <section className="w-full px-4 py-8 mt-auto bg-section-background md:py-16">
      <div className="lg:max-w-[80rem] mx-auto flex flex-col justify-center gap-8 md:flex-row">
        <div className="flex flex-col items-center w-full gap-4 md:w-1/2 xl:w-full xl:gap-40 md:items-start xl:flex-row">
          ...
          <div className="flex flex-col gap-4 text-center md:w-64 md:items-start">
            <Link className="text-base font-medium font-Raleway text-seconday-gray hover:underline">
              Quiénes Somos
            </Link>
            <Link className="text-base font-medium font-Raleway text-seconday-gray hover:underline">
        ...
        <form className="flex flex-col w-full gap-4" onSubmit={handleSubmit}>
          <h3 className="text-base font-bold font-Raleway text-seconday-gray">
            Hable con nosotros
          </h3>
          <div>
            ...
            <input
              className={`block p-2.5 w-full font-Raleway font-normal text-base text-seconday-gray border ${
                errors.name ? "border-red-500" : "border-primary-blue"
              } outline-none`}
              type="text"
              id="name"
              placeholder="Nombre"
          ...
          <button
            className="px-4 py-3 text-sm font-semibold text-white transition duration-300 ease-in-out font-Raleway bg-primary-blue w-36 hover:scale-110"
            type="submit"
          >
            Enviar Mensaje
          </button>
